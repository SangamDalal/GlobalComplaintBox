...
public class accountHOD extends javax.swing.JFrame {
PreparedStatement ps;
connect con;
DefaultTableModel comptabmod,comptabmod1;
Statement st_for_comp,st_for_specicomp,st_for_specicomplain,stchngpswd;
ResultSet rs_for_comp,rs_for_specicomp;
    ...
    public accountHOD() {
        ...
        comptabmod1=(DefaultTableModel)comptab1.getModel();
        open();
        viewcomp();
        allcomp();
    }
...
{sv.setVisible(false);
    try
      ...
      hloid.setText(main.fs.getString("usid"));
       phn4.setText(main.fs.getString("phone"));
...
{JOptionPane.showMessageDialog(rootPane, "Complaint can't be registered" + e);}
}
public void viewcomp()
    ...
    {JOptionPane.showMessageDialog(rootPane, "Unable to load my complaints" + e);}
    }
...
public void allcomp()
    ...
    {st_for_comp=con.cn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
        ...
        rs_for_comp=st_for_comp.executeQuery("select * from complaint where issue='"+main.fs.getString("qualification")+"' and department='"+deptt.getText()+"' and status='2' or status='3'");
    DefaultTableModel dm=(DefaultTableModel)comptab1.getModel();
       
       comptab1.setModel(dm);
        while(rs_for_comp.next())
        {
      Object o[]={rs_for_comp.getInt("cid"),rs_for_comp.getString("issue"),rs_for_comp.getString("description")};
      dm.addRow(o);
    ...
    {JOptionPane.showMessageDialog(rootPane, "Unable to load all complaints" + e);}
    }
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        phn4 = new javax.swing.JTextField();
        ...
        comptab1 = new javax.swing.JTable();
        jButton3 = new javax.swing.JButton();
        jButton4 = new javax.swing.JButton();
        fnlmsg = new javax.swing.JLabel();
        ...
        phn4.setEditable(false);
        phn4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Phone No.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        phn4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                phn4ActionPerformed(evt);
            }
        });
        ...
        qual.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "HOD of module", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(mail)
                                    .addGroup(jPanel6Layout.createSequentialGroup()
                                        .addComponent(qual, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(mail)
                            .addComponent(phn4, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(38, 38, 38)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(deptt, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(qual, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(29, 29, 29)
                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34)
                        .addComponent(updt, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sv, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        comptab1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        comptab1.setRowHeight(30);
        comptab1.getTableHeader().setReorderingAllowed(false);
        comptab1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                comptab1MouseClicked(evt);
            }
        });
        jScrollPane6.setViewportView(comptab1);

        jButton3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton3.setText("Working on it ");
        ...
        jButton4.setText("Issue Resolved");
        ...
        fnlmsg.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        fnlmsg.setForeground(new java.awt.Color(0, 255, 51));
        fnlmsg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane6, javax.swing.GroupLayout.DEFAULT_SIZE, 1140, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(104, 104, 104)
                .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(57, 57, 57)
                .addComponent(fnlmsg, javax.swing.GroupLayout.PREFERRED_SIZE, 469, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(fnlmsg, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(98, 98, 98)
                        .addComponent(msg, javax.swing.GroupLayout.PREFERRED_SIZE, 905, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
new main();}
    ...
    {case 0:statmsg.setText("Your complaint is dicarded by admin");statusprog.setValue(0);break;
     ...
     case 4:statmsg.setText("Issue resolved");statusprog.setValue(100);break;  
        ...
        {JOptionPane.showMessageDialog(rootPane, "Unable to load complaint" + e);}  
 
    }//GEN-LAST:event_comptabMouseClicked

    private void comptab1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_comptab1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_comptab1MouseClicked

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DefaultTableModel dm=(DefaultTableModel)comptab1.getModel();
        comptab1.setModel(dm);
        
        int row=comptab1.getSelectedRow();
         int ud=Integer.parseInt(comptabmod1.getValueAt(row,0).toString());
        try
        {st_for_specicomplain=con.cn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
           int i= st_for_specicomplain.executeUpdate("update complaint set status='3' where cid="+ud);
        if(i==1)
        {fnlmsg.setText("Status Updated");}}
        catch(Exception e)
        {JOptionPane.showMessageDialog(rootPane, "Unable to update complaint" + e);}
...
DefaultTableModel dm=(DefaultTableModel)comptab1.getModel();
        ...
        try
        {st_for_specicomplain=con.cn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
           int i= st_for_specicomplain.executeUpdate("update complaint set status='4' where cid="+ud);
        if(i==1)
        {fnlmsg.setText("Issue resolved");
        comptabmod1.removeRow(row);}}
        catch(Exception e)
        {JOptionPane.showMessageDialog(rootPane, "Unable to update complaint" + e);}      
   ...
   try
    ...
    private void phn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_phn4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_phn4ActionPerformed
    ...
    private void svActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_svActionPerformed
        ...
        if(isValidNo(phn4.getText())==false || phn4.getText().length()!=10)
        ...
        else
        {
            try
            {stchngpswd=con.cn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                int i=stchngpswd.executeUpdate("update faculty set phone='"+phn4.getText()+"',email='"+mail.getText()+"',qualification='"+qual.getText()+"', address='"+add.getText()+"' where usid = '" +hloid.getText()+"'");
                if(i==1)
    ...
    private javax.swing.JTextField phn4;
